...
class PipelineApi {
  ...
  ///
  /// 
  Future<Pipeline> pipelineAgents() async {
    Object postBody = null;

    // verify required params are set

    // create path and map variables
    String path = "/pipelines/status".replaceAll("{format}","json");
  ...
  ///
  /// 
  Future<List<Pipeline>> pipelineCurrent() async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<Pipeline> updatePipelineAgents({ Options options }) async {
