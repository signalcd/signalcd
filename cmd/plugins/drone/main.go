...
import (
	...
	client "github.com/signalcd/signalcd/api/client/go"
...
func action(c *cli.Context) error {
	...
	_, err = signalcd.ParseConfig(string(fileContent))
	if err != nil {
	...
	_ = client.NewAPIClient(clientCfg)
	...
	//pipelineID, err := createPipeline(client, config)
	//if err != nil {
	//	return fmt.Errorf("failed to create pipeline: %w", err)
	//}
	//
	//deploymentNumber, err := setCurrentDeployment(client, pipelineID)
	//if err != nil {
...
//func createPipeline(client *client.APIClient, config signalcd.Config) (string, error) {
//	client.PipelineApi.GetPipeline()
//
...
//}
//
//func setCurrentDeployment(client *client.APIClient, pipelineID string) (string, error) {
