...
// WithPipeline adds the pipeline to the create params
func (o *CreateParams) WithPipeline(pipeline *models.Pipeline) *CreateParams {
	o.SetPipeline(pipeline)
	return o
}

// SetPipeline adds the pipeline to the create params
func (o *CreateParams) SetPipeline(pipeline *models.Pipeline) {
	o.Pipeline = pipeline
}
