 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param setCurrentDeployment
@return Deployment
*/
func (a *DeploymentApiService) SetCurrentDeployment(ctx _context.Context, setCurrentDeployment SetCurrentDeployment) (Deployment, *_nethttp.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &setCurrentDeployment
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param deploymentStatusUpdate
@return Deployment
*/
func (a *DeploymentApiService) UpdateDeploymentStatus(ctx _context.Context, id int64, deploymentStatusUpdate DeploymentStatusUpdate) (Deployment, *_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/deployments/{id}/status"
	...
	// body params
	localVarPostBody = &deploymentStatusUpdate
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
